...
- (void)clientAddTableViewController:(ContactAddTableViewController *)clientAddTableViewController didAddClient:(Client *)client {
...
- (IBAction)addContact:(id)sender {
    ...
    UIAlertAction* newContactAction = [UIAlertAction actionWithTitle:@"새로 입력하기" style:UIAlertActionStyleDefault
                                                            handler:^(UIAlertAction * action) {
                                                            // showNewContact
                                                                [self performSegueWithIdentifier:@"showNewContact" sender:self];
                                                            }];
